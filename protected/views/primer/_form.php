...
<?php echo $form->error($model, 'idtbl_gen'); ?>
    ...
    <div class="row">
        <?php echo $form->labelEx($model, 'idtbl_estadoprimer'); ?>
<?php echo $form->textField($model, 'idtbl_estadoprimer'); ?>
<?php echo $form->error($model, 'idtbl_estadoprimer'); ?>
    </div>
    ...
    <div class="row">
        ...
        echo $form->dropDownList($model, 'idtbl_estadoprimer', 
                CHtml::listData($model->PrimerStatus, 'idtbl_estadoprimer', 'estado'), 
